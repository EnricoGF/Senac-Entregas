...
Dica: na hora de criar a frase, você pode utilizar as template strings que vimos na aula anterior! As variáveis da frase, nesse caso, serão os próprios 
parâmetros recebidos na função.
*/

function frase()
{
    console.log(`Eu sou Enrico, tenho 19 anos, moro em São Leopoldo e sou estudante`)
}
...
{
    let incompleta = `Eu sou ${nome}, tenho ${idade} anos, moro em ${cidade}, e sou ${profissao}`
    return incompleta
}
apresentacao("José", 19, "Belo Horizonte", "estudante")